...
export const categoriesDataUk: CategoryData[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: [
      "Фестиваль ",
      { strong: "YouthInsight" },
      " відбувається регулярно абоtitle щорічно та надає можливості аматорам із базового рівня представити свою медіатворчість, експериментувати й долучатися до медіапроєктів.\n\n",
