...
export const slides = [
  {
    ...
    gradient: "lg:bg-gradient-to-r lg:from-main-amarant/100 lg:via-main-amarant/15 lg:to-transparent",
  ...
  },
  {
    ...
    gradient: "lg:bg-gradient-to-r lg:from-main-blue/100 lg:via-main-blue/15 lg:to-transparent",
    gradientMob: "bg-gradient-to-t from-main-amarant/100 via-main-amarant/15 to-transparent",
